...
class MixVisionTransformer(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            ...
            load_checkpoint(self, pretrained, map_location='cpu', strict=True, logger=logger)
...
class SegFormer(nn.Module):
    def __init__(self, path):
        ...
        self.encoder = mit_b5()
        self.encoder.init_weights(path)
        # self.encoder.load_state_dict(torch.load('/content/drive/MyDrive/MLxAR/SSIW/Test_Minist/models/segformer_7data.pth')['state_dict'])
...
class EncoderClass(nn.Module):
    def __init__(self) -> None:
        ...
        self.encoder = mit_b5()
        self.encoder.init_weights("/content/drive/MyDrive/MLxAR/SSIW/Test_Minist/models/custom_new_name_2.pth")
